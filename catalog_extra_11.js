(function () {
  ...
  addRows([
    ...
    ["braintrust", "Braintrust", "Braintrust", "B", "linear-gradient(145deg, #2563eb, #22c55e)", "https://www.braintrustdata.com/", "An observability and evals platform for measuring AI quality, prompts, and production behavior.", buildLane, builders, "Paid", 5100000, "A solid add because evals are now a mainstream requirement for AI teams."],
  ...
  addRows([
    ...
    ["hyperbolic", "Hyperbolic", "Hyperbolic", "H", "linear-gradient(145deg, #2563eb, #ec4899)", "https://hyperbolic.xyz/", "An open-access AI cloud for GPUs, inference, and builder-friendly compute workflows.", buildLane, builders, "Usage-based", 6100000, "Useful for users comparing new AI-native compute platforms."],
  ...
  addRows([
    ...
    ["recall", "Recall", "Recall", "R", "linear-gradient(145deg, #111827, #8b5cf6)", "https://www.getrecall.ai/", "A personal knowledge tool for saving, organizing, and resurfacing what you read and watch.", productLane, researchers, "Freemium", 7900000, "A hot knowledge-management product with broad consumer and pro appeal."],
