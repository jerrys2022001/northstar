(function () {
  ...
  addRows([
    ...
    ["graphite", "Graphite", "Graphite", "G", "linear-gradient(145deg, #111827, #2563eb)", "https://graphite.com/", "A code review platform with AI help for stacked diffs, feedback, and engineering workflow speed.", buildLane, builders, "Paid", 4700000, "A hot engineering workflow tool that broadens the coding lane beyond copilots."],
  ...
  addRows([
    ...
    ["publer", "Publer", "Publer", "P", "linear-gradient(145deg, #111827, #f97316)", "https://www.publer.com/", "A social publishing suite with AI writing help, scheduling, and analytics across channels.", marketingLane, creators, "Freemium", 4700000, "A solid operator-friendly social stack with growing SMB demand."],
  ...
  addRows([
    ...
    ["outreach", "Outreach", "Outreach", "O", "linear-gradient(145deg, #111827, #2563eb)", "https://www.outreach.ai/", "A sales execution platform with AI assistance for prospecting, forecasting, and seller productivity.", salesLane, revenueTeams, "Paid", 11500000, "A major GTM operating platform with sustained buyer attention."],
    ...
    ["fathomvideo", "Fathom", "Fathom", "F", "linear-gradient(145deg, #111827, #2563eb)", "https://www.fathom.ai/", "An AI meeting recorder for summaries, follow-ups, and searchable team memory.", productLane, operators, "Freemium", 17600000, "A very visible meeting product with strong cross-functional demand."],
