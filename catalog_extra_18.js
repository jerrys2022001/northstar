(function () {
  ...
  addTools([
    ...
    ["stagehand", "Stagehand", "https://stagehand.dev/", "Browser automation layer that lets agents operate websites with less brittle scripting.", "Free / Paid", 5200000],
    ...
    ["codiumai", "CodiumAI", "https://www.codium.ai/", "Generate tests and code understanding help around developer workflows.", "Freemium", 6900000],
  ...
  addTools([
    ...
    ["notioncalendar", "Notion Calendar", "https://www.notion.so/product/calendar", "Bring calendar context into an AI-friendly workspace and planning flow.", "Free", 14300000],
    ...
    ["scribehow", "Scribe", "https://scribehow.com/", "Generate process guides and walkthrough docs from recorded actions.", "Freemium", 18800000],
  ...
  addTools([
    ...
    ["ema", "Ema", "https://www.ema.co/", "Deploy enterprise AI employees across support, IT, and ops workflows.", "Paid", 5000000],
    ["talkdeskai", "Talkdesk AI", "https://www.talkdesk.com/platform/artificial-intelligence/", "Layer AI automation and guidance into customer experience operations.", "Paid", 8800000],
  ...
  addTools([
    ...
    ["fibery", "Fibery", "https://fibery.io/", "Connect docs, workflows, and operations into one flexible AI-ready workspace.", "Paid", 3300000],
